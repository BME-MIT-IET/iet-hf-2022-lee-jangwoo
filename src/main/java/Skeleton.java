...
/**
 * Kezeli a felhaszn�l�val val� interakci�kat �s a men�t.
 * Az egyes parancsokhoz v�grehajtja a modellen a megfelel� m�veleteket, majd jelzi a felhaszn�l�nak, hogy mi t�rt�nt.
 */
public class Skeleton {
    ...
    /**
     * A load parancshoz tartoz� oszt�ly. A param�terk�nt megadott f�jlb�l beolvas egy p�ly�t.
     */
    ...
    /**
     * A setrandom parancshoz tartoz� oszt�ly. Be�ll�tja a random �rt�ket a felhaszn�l� �ltal megadott �rt�kre.
     */
    private static class setrandomCommand implements Command{
        /**
         * Be�ll�tja a random �rt�k�t a felhaszn�l� �ltal megadott �rt�kre.
         * Ha nincs el�g argumentum, akkor hiba�zenetet ad �s visszat�r.
         * @param args A parancs parancssori argumentumai, a teljes sort meg kell adni, amely sz�k�z�kkel lett elv�lasztva.
         */
        public void execute(String[] args) {
            if (args.length < 2) {
    ...
    /**
     * A selectsettler parancshoz tartoz� oszt�ly. A param�terk�nt megadott telepes lesz az akt�v telepes.
     */
    private static class selectsettlerCommand implements Command{

        /**
         * A param�terk�nt megadott telepes lesz az akt�v telepes.
         * Ha a telepes nem l�tezik vagy meghalt, akkor hib�t jelez.
         * @param args A parancs parancssori argumentumai, a teljes sort meg kell adni, amely sz�k�z�kkel lett elv�lasztva.
         */
        public void execute(String[] args) {
            if (args.length < 2){
    ...
    /**
     * Az exit parancshoz tartoz� oszt�ly.
     */
